        ...
        <div className="flex flex-col md:flex-row">
          <div className="flex-1 mr-[30px]">
            <h2 className="text-4xl font-medium mb-4 text-white drop-shadow-md lg:text-5xl">
              Become a <span className="text-red-600">Silver Member Now</span>{" "}
            </h2>
            ...
            <div className="bg-white hover:bg-green-200 font-bold cursor-pointer py-2 w-[300px] flex justify-center items-center shadow-md rounded-xl mt-8 text-indigo-700 hover:translate-y-[-4px] hover:shadow-xl transition ease-in-out ">
              Book Now
            </div>
          </div>
