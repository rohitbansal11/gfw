    ...
    <div className="flex flex-col my-10 py-10 mx-4 bg-white rounded-md shadow-lg">
      ...
      <div className="flex flex-col my-10">
        <div className="flex justify-between mx-10 md:mx-20 my-2">
          <h1 className="text-base md:text-lg lg:text-xl font-bold text-blue-600">
            Current MemberShip
          </h1>
          <h1 className="text-base md:text-lg lg:text-xl font-bold text-green-600">
            {data?.status?.sub_data?.sub_role?.toUpperCase() || " No Role"}
          </h1>
        </div>
        <div className="flex justify-between mx-10 md:mx-20">
          ...
          <h1 className="text-base md:text-lg lg:text-xl font-bold text-green-600">
            {data?.status?.sub_data?.status ? "Active" : "False"}
          </h1>
        </div>
        <div className="flex justify-between mx-10 md:mx-20 my-2">
          <h1 className="text-base md:text-lg lg:text-xl font-bold text-blue-600">
          ...
          <h1 className="text-base md:text-lg lg:text-xl font-bold text-green-600">
            {moment(data?.status?.sub_data?.end).format("DD-MMMM-YYYY") ||
              "No Subscription"}
          </h1>
        </div>
      </div>
