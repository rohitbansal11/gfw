  ...
  return (
    <div className="flex bg-white shadow-xl rounded-lg min-w-[300px] lg:min-w-[300px] mx-4 max-w-[350px]">
      <div className="flex flex-col px-4 py-4">
        ...
        <div className="text-gray-500 mb-2 mt-1 text-[12px]">{moment(new Date(item.createdAt)).format("MMMM Do YYYY, h:mm:ss a")}</div>
        {/* weight & type */}
        <div className="flex flex-col mt-2">
          <div className="flex  gap-2">
            <span className="font-medium ">Name:</span>{" "}
            <span className="text-[14px] text-gray-600">{item.title}</span>
          </div>
          <div className="flex  gap-2">
